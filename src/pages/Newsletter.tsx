    ...
    <div className="min-h-screen text-black relative overflow-hidden bg-black flex flex-col">
      ...
      <div className="relative z-20 flex-1 flex flex-col">
        ...
        <main className="flex-1 flex flex-col">
          ...
          <Link 
            to="/"
            className="fixed top-[100px] xs:top-[120px] sm:top-[140px] left-safe-left z-50 p-4 xs:p-6 sm:p-8 inline-flex items-center gap-2 text-white hover:text-white/70 transition-colors"
          >
