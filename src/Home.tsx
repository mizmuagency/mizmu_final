          ...
          <div className="container mx-auto px-4 md:px-8 pt-32 xs:pt-36 sm:pt-40 pb-12 md:pb-20 flex-1 mx-5">
            ...
            <div className="min-h-[90vh] flex flex-col justify-center relative">
              <div className="relative">
                <h1 className="text-left text-5xl xs:text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tight leading-[0.9] max-w-full md:max-w-[80%] md:ml-[170px] lg:ml-[210px] -mt-[45px]">
                  digitale<br />Magie.
                </h1>
                <div className="relative mt-6 text-left max-w-full md:max-w-[600px] md:left-[calc(50%+200px)] md:-translate-x-1/2 mb-12">
                  <div className="text-sm xs:text-base sm:text-lg md:text-xl font-normal leading-tight tracking-tight">
                    mizmu ist eine progressive digitale<br className="block xs:hidden" />
                    Agentur, bei der Ästhetik auf<br className="block xs:hidden" />
                    Funktionalität trifft. Dank unserem<br className="block xs:hidden" />
                    technischen Know-How und feinem<br className="block xs:hidden" />
                    Designgespür, verwandeln wir<br className="block xs:hidden" />
                    deinen Brand in sein bestes digitales Selbst.
                  </div>
                </div>
              </div>
            </div>
