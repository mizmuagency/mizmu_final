...
import KompetenzenContactForm from './KompetenzenContactForm';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-6 sm:mb-8 md:mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/webdesign" className="text-neutral-300 hover:text-white transition-colors leading-none block" aria-label="Webdesign und Development">Webdesign & Development</Link></li>
                <li><Link to="/projekte" className="text-neutral-300 hover:text-white transition-colors leading-none block" aria-label="Unsere Projekte">Projekte</Link></li>
                <li><Link to="/about" className="text-neutral-300 hover:text-white transition-colors leading-none block" aria-label="Über uns">About</Link></li>
                <li><button onClick={() => setIsContactModalOpen(true)} className="text-neutral-300 hover:text-white transition-colors leading-none block" aria-label="Kontakt aufnehmen">Kontakt</button></li>
                <li><Link to="/blog" className="text-neutral-300 hover:text-white transition-colors leading-none block" aria-label="Blog lesen">Blog</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/faq" className="text-neutral-300 hover:text-white transition-colors leading-none block font-bold">FAQs</Link></li>
                <li><a href="https://open.spotify.com/playlist/3di7iTd1XuHDME9v2MazWh?si=Lew2CyzdRbeL5GkMdjdRHg" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-white transition-colors leading-none block font-bold">mizmu.sic</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <MagneticButton>
                <Link 
                  to="/newsletter"
                  className="inline-flex items-center justify-between border-2 border-white rounded-full px-6 py-2 hover:bg-white hover:text-black transition-colors tracking-tight whitespace-nowrap text-base sm:text-lg w-[163.26px]"
                >
